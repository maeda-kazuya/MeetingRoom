...
//let input = [[2, 3, 6], [4, 1, 2], [3, 3, 8], [5,2,8], [3, 5, 11], [5, 5, 20], [5, 5, 16]]
//let input = [[5,2,8]]
//let input = [[4,3,7]] // -> 2
//let input = [[3,5,9]] // -> 3
//let input = [[3,3,6]]
...
//        var surroundedBlankCellCount = ((totalRow - 2) * (totalColumn - 2)) / 2
        ...
        surroundedBlankCellCount = (surroundedBlankCellCount == 1 ) ? surroundedBlankCellCount : surroundedBlankCellCount / 2
...
//        print("restCellCount - surroundedBlankCellCount: " + String(restCellCount - surroundedBlankCellCount))
        ...
        if (d < restCellCount - surroundedBlankCellCount + 1) {
//            print("A")
            result = 3 * d
        } else {
//            print("B")
        ...
        if (d < 3) {
            result = 2 * d
//        } else if (d < blankCellCount - surroundedBlankCellCount) {
